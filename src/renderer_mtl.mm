...
namespace bgfx { namespace mtl
{
	...
	static TextureFormatInfo s_textureFormat[] =
	{
		...
		{ MTLPixelFormat(42/*ABGR4Unorm*/),             MTLPixelFormatInvalid,                       MTLReadWriteTextureTierNone, true,  MTLTextureSwizzleChannelsMake(MTLTextureSwizzleAlpha, MTLTextureSwizzleBlue, MTLTextureSwizzleGreen, MTLTextureSwizzleRed) }, // RGBA4
