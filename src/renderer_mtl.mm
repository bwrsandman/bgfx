...
namespace bgfx { namespace mtl
{
	...
	static TextureFormatInfo s_textureFormat[] =
	{
		...
		{ MTLPixelFormat(41/*A1BGR5Unorm*/),            MTLPixelFormatInvalid,                       MTLReadWriteTextureTierNone, true,  MTLTextureSwizzleChannelsMake(MTLTextureSwizzleBlue, MTLTextureSwizzleGreen, MTLTextureSwizzleRed, MTLTextureSwizzleAlpha) }, // RGB5A1
